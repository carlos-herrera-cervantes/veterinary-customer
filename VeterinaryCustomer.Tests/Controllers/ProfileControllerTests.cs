...
namespace VeterinaryCustomer.Tests.Controllers
{
    ...
    public class ProfileControllerTests
    {
        ...
        {
            _mockProfileRepository.Setup(x => x.GetAllAsync(It.IsAny<int>(), It.IsAny<int>())).ReturnsAsync(new List<Profile>{});
            _mockProfileRepository.Setup(x => x.CountAsync(It.IsAny<FilterDefinition<Profile>>())).ReturnsAsync(0);
        ...
        {
            _mockProfileRepository.Setup(x => x.GetByCustomerIdAsync(It.IsAny<string>())).ReturnsAsync(() => null);
        ...
        {
            _mockProfileRepository.Setup(x => x.GetByCustomerIdAsync(It.IsAny<string>())).ReturnsAsync(new Profile{});
        ...
        {
            _mockProfileRepository.Setup(x => x.GetByCustomerIdAsync(It.IsAny<string>())).ReturnsAsync(new Profile{});
            _mockProfileRepository.Setup(x => x.UpdateAsync(It.IsAny<Profile>())).Returns(Task.FromResult(true));
